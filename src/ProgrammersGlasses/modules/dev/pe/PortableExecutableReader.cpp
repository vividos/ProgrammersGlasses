...
#include "../coff/CoffObjectNodeTreeBuilder.hpp"
...
void PortableExecutableReader::Load()
{
   ...
   {
      size_t coffObjectSize = coffHeader - fileStart;
      CoffObjectNodeTreeBuilder nodeTreeBuilder{ m_file, coffObjectSize, true };
